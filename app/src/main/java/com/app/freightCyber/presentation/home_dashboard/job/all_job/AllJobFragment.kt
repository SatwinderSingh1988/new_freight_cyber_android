package com.app.freightCyber.presentation.home_dashboard.job.all_job
...
import com.app.freightCyber.databinding.FragmentAllJobBinding
...
@AndroidEntryPoint
class AllJobFragment  : BaseFragment<FragmentAllJobBinding>(){

    private val viewModel : AllJobFragmentVM by viewModels()
    ...
    override fun onCreateView(view: View) {
     ...
     private fun setJobAdapter() {
         ...
         binding.rvAllJobRequest.adapter = jobAdapter
