package com.app.freightCyber.presentation.home_dashboard.job.rejected_job
...
import com.app.freightCyber.databinding.FragmentRejectedJobBinding
...
@AndroidEntryPoint
class RejectedJobFragment  : BaseFragment<FragmentRejectedJobBinding>(){

    private val viewModel : RejectedJobFragmentVM by viewModels()

    override fun getLayoutResource(): Int {
        return R.layout.fragment_rejected_job
    }
    ...
    override fun onCreateView(view: View) {
     ...
     private fun setJobAdapter() {
         ...
         binding.rvRejected.adapter = jobAdapter
