...
class AdditionalIdentificationUseCase @Inject constructor(private val authRepository: AuthRepository) {
    ...
    suspend operator fun invoke(additionalIdentificationRequest: AdditionalIdentificationRequest) : Flow<NetworkResult<AdditionalIdentificationResponse>> {
     return   authRepository.additionalIdentification(additionalIdentificationRequest)
    }
}