...
class GetEmergencyContactUseCase @Inject constructor(private val authRepository: AuthRepository){

    suspend operator fun invoke(): Flow<NetworkResult<EmergencyContactResponse>> {
        return authRepository.getEmergencyContact()
    }
}