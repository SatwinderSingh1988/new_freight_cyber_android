...
@Parcelize
data class AdditionalIdentificationResponse(
    val `data`: AdditionalIdentificationData?,
    val message: String?,
    val status: Int?
) : Parcelable

@Parcelize
data class AdditionalIdentificationData(
...
@Parcelize
data class AdditionalIdentification(
    val expiry: String?,
    val id_type: String?,
